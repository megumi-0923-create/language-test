...
class surface_lang_detect(unittest.TestCase):
    ...
    def test_02left_menu(self):
        ...
        for i in range(2):
            element = driver.find_element(By.XPATH,f'//*[@id="__nuxt"]/section/main/section/div/aside/div/div[2]/div[{i + 1}]/span')
            element_html = element.get_attribute("outerHTML")
    ...
    def test_03left_modules(self):
        #点击Modules按钮
        driver.find_element(By.XPATH, f'//*[@id="__nuxt"]/section/main/section/div/aside/div/div[2]/div[1]/span').click()
        #检查modules下的所有分类页签
        for i in range(40):
    ...
    def test_04left_references(self):
        #点击References按钮
        driver.find_element(By.XPATH,f'//*[@id="__nuxt"]/section/main/section/div/aside/div/div[2]/div[2]/span').click()
        #依次点开所有一级分类，并检测一级分类
        for i in range(4):
            if i<3:
                driver.find_element(By.XPATH,f'//*[@id="__nuxt"]/section/main/section/div/aside/div/div[4]/div/div/ul/li[{i+1}]/div/div/a').click()
            element = driver.find_element(By.XPATH,f'//*[@id="__nuxt"]/section/main/section/div/aside/div/div[4]/div/div/ul/li[{i+1}]/div/div/a')
            element_html = element.get_attribute("outerHTML")
            element_text = element.text
            result = contains_lang_chars(thai_ranges, element_text)
        ...
        for i in range(2):
            for j in range(35):
                ...
                if i==1 and j==19:
                    break
                driver.find_element(By.XPATH,f'//*[@id="__nuxt"]/section/main/section/div/aside/div/div[4]/div/div/ul/li[{i+1}]/ul/li[{j+1}]/div/div/span').click()
                element = driver.find_element(By.XPATH,f'//*[@id="__nuxt"]/section/main/section/div/aside/div/div[4]/div/div/ul/li[{i+1}]/ul/li[{j+1}]/div/div/span')
                element_html = element.get_attribute("outerHTML")
                element_text = element.text
                result = contains_lang_chars(thai_ranges, element_text)
                write_result(element_text,element_html,  result)
        #检测aside，type下的所有分类
        element_aside_type=driver.find_element(By.XPATH,'//*[@id="__nuxt"]/section/main/section/div/aside/div/div[4]/div/div/ul/li[3]/ul').get_attribute('outerHTML')
    ...
    def test_05enum_index(self):
        #点击左侧enum页
        driver.find_element(By.XPATH,'//*[@id="__nuxt"]/section/main/section/div/aside/div/div[4]/div/div/ul/li[4]/div/div/a').click()
        time.sleep(1)
        #检测index下的表格内容
    ...
    def test_06enum_rest(self):
        ...
        time.sleep(1)
        #references
        det_lang_new(driver,'//*[@id="__nuxt"]/section/main/section/div/section/section/section/nav/ol/li/span',thai_ranges)
        #大标题enum
        det_lang_new(driver,'//*[@id="__nuxt"]/section/main/section/div/section/section/section/section[1]/h1',thai_ranges)
        #下方的其余内容
        element_html=driver.find_element(By.XPATH,'//*[@id="__nuxt"]/section/main/section/div/section/section/section/section[3]/article').get_attribute("outerHTML")
        #检测标签中含有a的内容
    ...
    def test_07nav(self):
        ...
        # 点击break loop
        driver.find_element(By.XPATH,'//a[@class="router-link-active router-link-exact-active transition-colors duration-300 hover:text-primary"]').click()
        time.sleep(0.5)
        #上方导航
        html_element = driver.find_element(By.XPATH,'//*[@id="__nuxt"]/section/main/section/div/section/section/section/nav').get_attribute('outerHTML')
        ...
        write_result('', '', '')
        #点击左侧列表后，检查
        elements = driver.find_elements(By.XPATH,'//a[@class="transition-colors duration-300 hover:text-primary"][contains(@href, "/th/docs/api-") or contains(@href, "/th/docs/event-") or contains(@href, "/th/docs/type-")]')
        ...
        for i, element in enumerate(elements):
            ...
            if 'เก่า' in element.get_attribute('textContent') or element.get_attribute('textContent')=='':
                continue
            ...
            # WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH,f'//a[@class="transition-colors duration-300 hover:text-primary"][@href="{result_url}"]')))
            print('<<<<<')
            element_new = driver.find_element(By.XPATH,f'//a[@class="transition-colors duration-300 hover:text-primary"][@href="{result_url}"]')
            element_new.click()
            time.sleep(2)
            # 整个中间页面的元素
            # WebDriverWait(driver,10).until(EC.presence_of_element_located((By.XPATH,'//*[@id="__nuxt"]/section/main/section/div/section/section/section')))
            print('>>>>>>')
            element_root_middle = driver.find_element(By.XPATH, '//section[@class="app-docs-content"]').get_attribute('outerHTML')
            # 标题下方所属二级分类等那一行的元素
            # WebDriverWait(driver,60).until(EC.presence_of_element_located((By.XPATH, '//*[@id="__nuxt"]/section/main/section/div/section/section/section/section[1]/section/div/div')))
            ...
            if 'api' in result_url or 'event' in result_url:
                try:
                    ...
                    # WebDriverWait(driver,5).until(EC.presence_of_element_located((By.XPATH,'//*[@id="__nuxt"]/section/main/section/div/section/section/section/section[3]/article/div[1]/pre/code/span')))
                    element_declaration=driver.find_element(By.XPATH,'//span[@class="hljs-keyword"]')
                    #该脚本的h1标题
                    element_h1_text=driver.find_element(By.XPATH,'//*[@id="__nuxt"]/section/main/section/div/section/section/section/section[1]/h1').get_attribute('textContent')
    ...
    def test_08_Firstlevel_Directory(self):
        for i in range(3):
            ...
            element_root_aside = driver.find_element(By.XPATH, '//*[@id="__nuxt"]/section/main/section/div/section/section/aside').get_attribute('outerHTML')
    ...
    def test_09_modules_middle(self):
        ...
        for i in range(40):
            ...
            module_middle_root = driver.find_element(By.XPATH, '//*[@id="__nuxt"]/section/main/section/div/section/section/section]').get_attribute('outerHTML')
            ...
            WebDriverWait(driver,10).until(EC.presence_of_element_located((By.XPATH,'//*[@id="__nuxt"]/section/main/section/div/section/section/section/section[1]/section/div/div/div/div/div')))
